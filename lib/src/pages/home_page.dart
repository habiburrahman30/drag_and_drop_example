        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (dragAndDropC.list2.isNotEmpty)
                ListView.builder(
                  itemCount: dragAndDropC.list2.length,
                  shrinkWrap: true,
                  primary: false,
                  itemBuilder: (BuildContext context, int index) {
                    final item = dragAndDropC.list2[index];
                    return Container(
                      width: Get.width,
              ...
              DragTarget<int>(
                onAccept: (v) {
                  dragAndDropC.list2.add(v);
                  dragAndDropC.list.remove(v);
                  print(v);
                },
                ...
                //   return true;
                // },
                builder: (context, acceptedItems, rejectedItem) => DottedBorder(
                  color: hexToColor('#FFE1BF'),
                  strokeWidth: 2,
                  dashPattern: [4, 4],
                  borderType: BorderType.RRect,
              ...
              ListView.builder(
                itemCount: dragAndDropC.list.length,
                shrinkWrap: true,
                primary: false,
                itemBuilder: (BuildContext context, int index) {
                  final item = dragAndDropC.list[index];
